...
txtUsername.setMaxWidth(200);//tmbh
txtPassword.setMaxWidth(200); //tmbh
txtConfirm.setMaxWidth(200); //tmbh

        Button btnCreate = new Button("Create Account");
        btnCreate.setTranslateY(20);//tmbh
