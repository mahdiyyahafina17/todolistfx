...
public class TaskHandlerPage {
    ...
    academicPage.show( primaryStage, username);
        ...
        btnPersonal.setPrefWidth(180); //tmbh

        btnAcademic.setPrefWidth(180); //tmbh

        btnBack.setPrefWidth(100);//tmbh

        
        btnPersonal.setStyle( //tmbh
    "-fx-background-radius: 10;"
    + "-fx-font-weight: bold;"
    );

        btnAcademic.setStyle( //tmbh
    "-fx-background-radius: 10;"
    + "-fx-font-weight: bold;"
    );

    btnBack.setStyle( //tmbh
    "-fx-background-radius: 10;"
    );
